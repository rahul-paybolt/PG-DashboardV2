...
const CustomModal = ({isOpen, handleModal, title, content}:CustomModalProps) => {
    ...
    <>
      ...
      >
        <ModalContent>
          ...
          <ModalBody>
            <div className='mb-2'>
              <p className='text-danger-500'>Note: Download this <span className='text-green-500'>sample file</span> for your references</p>
              <p className=' text-secondary text-center py-2'>Only Xls, Xlsx file can be uploded</p>
